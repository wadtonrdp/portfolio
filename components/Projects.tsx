...
const projectsList = [
  {
    title: 'NEXO — E-commerce',
    subtitle: 'Em desenvolvimento',
    description: 'Plataforma de e-commerce com Next.js App Router, autenticação de usuários, carrinho de compras e banco de dados relacional com Prisma ORM. MVP em produção em breve.',
            ...
            >
              <div className="relative h-52 w-full overflow-hidden">
                <div className="absolute inset-0 bg-[#534AB7]/20 z-10 opacity-0 group-hover:opacity-100 transition-opacity duration-500 flex items-center justify-center gap-4">
                  <a href={project.github} target="_blank" rel="noopener noreferrer" className="p-3 bg-[#0f0f0f] rounded-full text-white hover:scale-110 transition-transform">
                  ...
                  {project.link && (
                    <a href={project.link} target="_blank" rel="noopener noreferrer" className="p-3 bg-[#534AB7] rounded-full text-white hover:scale-110 transition-transform">
              ...
              <div className="p-6">
                ...
                <div className="flex items-center gap-2 text-[#AFA9EC] text-sm font-medium group/btn">
                  {project.link ? 'Ver projeto' : 'Ver código'} 
